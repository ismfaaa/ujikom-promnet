  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  <p>
                    <?= $_SESSION['username'] ?>
                    <small>User SIMBS since August 2024</small>
                  </p>
                </li>
                <!--end::User Image-->
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="index.php" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">UJIKOM</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
              ...
              <!-- =============== ISI FORM NYA DI SINI =============== -->
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="halaman" id="halaman" value="<?= $buku['halaman'] ?>" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun Tebrit</label>
                        <input type="number" class="form-control" name="tahun_terbit" id="tahun_terbit" value="<?= $buku['tahun_terbit'] ?>" autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="genre" id="genre" value="<?= $buku['genre'] ?>" autocomplete="off">
                    </div>
                    <div class="mb-3">
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Bismillah Ujikom Promnet</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
          Copyright &copy; 2025&nbsp;
